...
export default function LegalPage() {
  ...
  const sections = [
      { title: "Terms of Use", content: "Our Terms of Use govern your access to and use of the Ethiofy platform. By using Ethiofy you agree to these terms." },
      { title: "Privacy", content: "We respect your privacy and handle your personal information responsibly. We collect only what's needed to operate the marketplace and never sell your personal data." },
      { title: "Acceptable Use", content: "Listings must be lawful, accurate, and appropriate. Prohibited items, misleading content, and fraudulent activity are not permitted and may result in removal." },
      { title: "Intellectual Property", content: "Ethiofy's name, logo, and platform are protected. Content you post remains yours, but you grant Ethiofy the right to display it on the platform." },
      { title: "Questions", content: "For any legal inquiry, please reach out through our contact page." }
    ]
    ...
    <main style={{minHeight:'100vh',background:'#F9FAFB',fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif'}}>
      ...
      <div style={{maxWidth:'800px',margin:'0 auto',padding:'48px 20px 80px'}}>
        <div style={{marginBottom:'40px'}}>
          <h1 style={{fontSize:'28px',fontWeight:900,color:'#111',marginBottom:'8px'}}>Legal Hub</h1>
          <div style={{fontSize:'14px',color:'#6B7280',lineHeight:1.7}}>Terms, privacy, and policies governing your use of Ethiofy.</div>
        </div>
