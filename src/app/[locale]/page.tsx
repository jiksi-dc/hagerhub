...
const POPULAR = [
  { name: 'Properties', items: ['Residential for Rent', 'Residential for Sale', 'Commercial', 'Land & Plots'], color: '#6B7280', emoji: '🏠' },
...
const CAT_COLORS: Record<string,string> = { Properties:'#6B7280', Vehicles:'#1B6BB5', Machinery:'#C9A84C', Classifieds:'#8B5E3C', Jobs:'#EF2118' }
...
export default function Home() {
  ...
  return (
    <main style={{fontFamily:'inherit',background:'#F3F4F6',minHeight:'100vh',width:'100%',overflowX:'hidden'}}>
      ...
      <div style={{background:"white",padding:"10px 16px",display:"flex",gap:"10px",alignItems:"center",borderBottom:"1px solid #eee"}}><AuthButton /><a href="/post" style={{background:"#6B7280",color:"white",padding:"8px 18px",borderRadius:"20px",fontSize:"13px",fontWeight:700,textDecoration:"none"}}>+ Post Ad</a></div>
              ...
              <>
                ...
                {i===5 && <div key="ad2" style={{gridColumn:'1/-1',borderRadius:'18px',overflow:'hidden',cursor:'pointer',boxShadow:'0 8px 28px rgba(0,0,0,0.2)',position:'relative'}}>
                  ...
                  <div style={{position:'absolute',inset:0,background:'linear-gradient(to right,rgba(0,0,0,0.92) 0%,rgba(0,0,0,0.15) 100%)',display:'flex',alignItems:'center',padding:'22px',gap:'14px'}}>
                    <div style={{flex:1}}><div style={{fontSize:'8px',color:'rgba(255,255,255,0.35)',letterSpacing:'2px',marginBottom:'8px'}}>{tx.ad} · TOYOTA ETHIOPIA</div><div style={{fontSize:'26px',fontWeight:900,color:'white',marginBottom:'4px',lineHeight:1}}>Land Cruiser</div><div style={{fontSize:'14px',fontWeight:700,color:'#6B7280',marginBottom:'6px'}}>2025 Edition</div><div style={{fontSize:'11px',color:'rgba(255,255,255,0.65)'}}>The ultimate off-roader</div></div>
                ...
                <div key={l.id} style={{background:'#F3F4F6',borderRadius:'18px',overflow:'hidden',boxShadow:'0 3px 14px rgba(0,0,0,0.08)',cursor:'pointer'}}>
                  <div style={{position:'relative',height:isDesktop?'420px':'280px',overflow:'hidden'}}>
                    ...
                    <div style={{position:'absolute',top:'12px',left:'12px',background:CAT_COLORS[l.category]||'#6B7280',color:'white',fontSize:'10px',fontWeight:800,padding:'5px 14px',borderRadius:'20px',letterSpacing:'0.5px'}}>{tl(l.category)}</div>
                  ...
                  <div style={{padding:'14px 16px',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
                    ...
                    <button style={{background:'#6B7280',color:'white',border:'none',borderRadius:'12px',padding:'9px 22px',fontSize:'13px',fontWeight:800,cursor:'pointer'}} onClick={()=>window.location.href=`/listing/${l.id}`}>{tx.view}</button>
                  </div>
                </div>
              </>
            ))}
      ...
      <div style={{margin:'0 16px 20px',borderRadius:'18px',overflow:'hidden',cursor:'pointer',boxShadow:'0 8px 28px rgba(0,0,0,0.2)',position:'relative'}}>
        ...
        <div style={{position:'absolute',inset:0,background:'linear-gradient(135deg,rgba(0,100,0,0.93) 0%,rgba(0,60,0,0.55) 100%)',display:'flex',alignItems:'center',padding:'20px',gap:'16px'}}>
          ...
          <div style={{background:'#6B7280',color:'#111',fontSize:'12px',fontWeight:900,padding:'12px 18px',borderRadius:'14px',whiteSpace:'nowrap',flexShrink:0}}>Book Now</div>
        </div>
      </div>
      ...
      <footer style={{background:'#090909',padding:'32px 16px 28px'}}>
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',borderTop:'1px solid rgba(255,255,255,0.05)',paddingTop:'18px'}}>
          ...
          <div style={{display:'flex',height:'3px',width:'42px',borderRadius:'2px',overflow:'hidden'}}><div style={{flex:1,background:'#6B7280'}}/><div style={{flex:1,background:'#6B7280'}}/><div style={{flex:1,background:'#EF2118'}}/></div>
        </div>
      </footer>
    </main>
  )
