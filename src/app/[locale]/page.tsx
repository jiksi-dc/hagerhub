...
export default function Home() {
  ...
  return (
    <main style={{fontFamily:'inherit',background:'#EEF2FF',minHeight:'100vh',width:'100%',overflowX:'hidden'}}>
      <section style={{background:'#EEF2FF',padding:'28px 16px 24px',textAlign:'center',position:'relative',overflow:'visible'}}>
        ...
        <div style={{display:'flex',background:'#EEF2FF',borderRadius:'14px',overflow:'hidden',boxShadow:'0 2px 12px rgba(0,0,0,0.1)',border:'1.5px solid #eee',marginBottom:'16px'}}>
        ...
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'12px 16px',gap:'12px'}}>
          <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
            <div style={{width:'48px',height:'48px',borderRadius:'50%',flexShrink:0,position:'relative',overflow:'hidden',border:'3px solid rgba(255,255,255,0.3)'}}>
              <div style={{position:'absolute',top:0,left:0,right:0,height:'50%',background:'#c00'}}/><div style={{position:'absolute',bottom:0,left:0,right:0,height:'50%',background:'#001489'}}/><div style={{position:'absolute',top:'46%',left:0,right:0,height:'8%',background:'#EEF2FF'}}/>
            </div>
      ...
      <div style={{background:'linear-gradient(90deg,#CC4A00,#FF7A00)',padding:'13px 16px',display:'flex',alignItems:'center',justifyContent:'space-between',cursor:'pointer',gap:'12px'}}>
        <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
          <div style={{width:'42px',height:'42px',borderRadius:'12px',background:'#EEF2FF',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,fontSize:'22px'}}>📱</div>
        ...
        <div style={{background:'#EEF2FF',color:'#CC4A00',fontSize:'12px',fontWeight:900,padding:'10px 18px',borderRadius:'20px',whiteSpace:'nowrap',flexShrink:0}}>Get App</div>
      </div>

      {activeCat==='All' && (
        <section style={{background:'#EEF2FF',padding:'22px 16px',borderBottom:'8px solid #F0F2F5'}}>
      ...
      <section style={{padding:'18px 16px'}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'18px'}}>
          ...
          {activeCat!=='All' && (<button onClick={()=>setActiveCat('All')} style={{fontSize:'12px',color:'#60A5FA',background:'#EEF2FF',border:'1.5px solid #0057D9',borderRadius:'20px',padding:'8px 18px',cursor:'pointer',fontWeight:700}}>{tx.back}</button>)}
        </div>
            ...
            {filtered.map((l,i)=>(
              <>
                {i===2 && <div key="ad1" style={{gridColumn:'1/-1',background:'linear-gradient(135deg,#001A6E,#0041C4)',borderRadius:'18px',padding:'18px',display:'flex',alignItems:'center',gap:'14px',cursor:'pointer',boxShadow:'0 8px 28px rgba(0,26,110,0.4)'}}>
                  <div style={{width:'56px',height:'56px',borderRadius:'16px',background:'#EEF2FF',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,fontSize:'28px'}}>🏦</div>
                ...
                {i===8 && <div key="ad3" style={{gridColumn:'1/-1',background:'linear-gradient(135deg,#5C0000,#8B0000)',borderRadius:'18px',padding:'18px',display:'flex',alignItems:'center',gap:'14px',cursor:'pointer',boxShadow:'0 8px 28px rgba(92,0,0,0.4)'}}>
                  ...
                  <div style={{background:'#EEF2FF',color:'#5C0000',fontSize:'12px',fontWeight:900,padding:'12px 16px',borderRadius:'14px',whiteSpace:'nowrap',flexShrink:0}}>Learn More</div>
                </div>}
                <div key={l.id} style={{background:'#EEF2FF',borderRadius:'18px',overflow:'hidden',boxShadow:'0 3px 14px rgba(0,0,0,0.08)',cursor:'pointer'}}>
      ...
      <section style={{margin:'0 16px 24px',background:'linear-gradient(135deg,#090909,#191919)',borderRadius:'22px',padding:'30px 22px',textAlign:'center'}}>
        ...
        <div style={{display:'flex',gap:'12px',justifyContent:'center'}}>
          <button style={{background:'#EEF2FF',color:'#111',border:'none',borderRadius:'14px',padding:'14px 24px',fontSize:'14px',fontWeight:800,cursor:'pointer'}}>🍎 App Store</button>
