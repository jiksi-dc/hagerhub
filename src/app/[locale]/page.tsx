...
@keyframes featuredshimmer { 0%,100%{box-shadow:0 0 0 rgba(218,165,32,0)} 50%{box-shadow:0 4px 20px rgba(218,165,32,0.15)} }
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 768px) {
          ...
          .nav-mobilebtns > * { flex: 1 1 0 !important; }
      ...
      <section className="hero-section" style={{position:'relative',width:'100%',minHeight:'340px',background:'#f9fafb',overflow:'hidden'}}>
        ...
        <div style={{maxWidth:'480px',flex:'0 0 auto',display:'flex',flexDirection:'column',alignItems:'flex-start'}}>
          ...
          <div className="hero-tabs" style={{overflowX:'auto',display:'flex',gap:'3px',background:'transparent',padding:'4px',borderRadius:'12px',marginBottom:'14px',flexWrap:'nowrap',justifyContent:'flex-start',maxWidth:'100%',overflowX:'auto',WebkitOverflowScrolling:'touch',scrollbarWidth:'none',msOverflowStyle:'none'}}>
            {TABS.map(tab=>{
