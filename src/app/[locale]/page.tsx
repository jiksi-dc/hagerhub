...
@keyframes featuredshimmer { 0%,100%{box-shadow:0 0 0 rgba(218,165,32,0)} 50%{box-shadow:0 4px 20px rgba(218,165,32,0.15)} }
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 768px) {
          ...
          .hero-section img { top: 0 !important; bottom: auto !important; height: 205px !important; object-position: center 62% !important; }
          .hero-section > div:first-of-type { bottom: auto !important; height: 205px !important; background: linear-gradient(to bottom, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.28) 60%, rgba(0,0,0,0.42) 100%) !important; }
