...
@keyframes featuredshimmer { 0%,100%{box-shadow:0 0 0 rgba(218,165,32,0)} 50%{box-shadow:0 4px 20px rgba(218,165,32,0.15)} }
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 768px) {
          ...
          .hero-panel { width: 100% !important; padding: 14px !important; margin-top: 0 !important; } .hero-mobilebtns { display: flex !important; justify-content: center !important; } .hero-panel { display: none !important; } .hero-panel.mob-open { display: block !important; } .hero-mobile-ai { display: flex !important; } .hero-mobilebtns button { white-space: nowrap !important; font-size: 15px !important; height: 52px !important; padding: 0 22px !important; gap: 7px !important; border-radius: 12px !important; flex: 0 1 auto !important; min-width: 140px !important; background: #2563EB !important; color: #fff !important; border-color: #2563EB !important; } .browse-box { display: none !important; }
