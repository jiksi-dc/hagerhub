...
@keyframes featuredshimmer { 0%,100%{box-shadow:0 0 0 rgba(218,165,32,0)} 50%{box-shadow:0 4px 20px rgba(218,165,32,0.15)} }
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 768px) {
          ...
          .hero-panel { width: 100% !important; padding: 14px !important; margin-top: 0 !important; } .hero-mobilebtns { display: none !important; } .hero-panel { display: none !important; } .hero-panel.mob-open { display: block !important; position: absolute !important; top: 10px !important; left: 12px !important; right: 12px !important; z-index: 60 !important; width: auto !important; max-height: 72vh !important; overflow-y: auto !important; background: #fff !important; border-radius: 14px !important; box-shadow: 0 12px 32px rgba(0,0,0,0.22) !important; } .hero-mobile-ai { display: flex !important; position: absolute !important; top: 10px !important; left: 12px !important; right: 12px !important; z-index: 60 !important; } .hero-mobilebtns button { white-space: nowrap !important; font-size: 15px !important; height: 52px !important; padding: 0 22px !important; gap: 7px !important; border-radius: 12px !important; flex: 1 1 0 !important; min-width: 0 !important; max-width: 200px !important; box-sizing: border-box !important; background: #2563EB !important; color: #fff !important; border-color: #2563EB !important; } .browse-box { display: none !important; }
          .hero-tabs { display: none !important; }
          .hero-title { display: none !important; }
          .mob-popular { display: block !important; font-size: 22px; font-weight: 900; color: #111; margin: 0 0 2px; }
          #results { padding-top: 2px !important; }
          .nav-cats { display: flex !important; width: 100%; overflow-x: auto; gap: 2px; padding: 0 10px; margin: 0; scrollbar-width: none; }
      ...
      <section className="hero-section" style={{position:'relative',width:'100%',minHeight:'340px',background:'#f9fafb',overflow:'hidden'}}>
        ...
        <div style={{maxWidth:'480px',flex:'0 0 auto',display:'flex',flexDirection:'column',alignItems:'flex-start'}}>
          <div className="mob-popular" style={{display:'none'}}>Popular in Categories</div><div className="hero-title" style={{textAlign:'left',marginBottom:'22px'}}>
