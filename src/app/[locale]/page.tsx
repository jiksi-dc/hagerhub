...
@keyframes featuredshimmer { 0%,100%{box-shadow:0 0 0 rgba(218,165,32,0)} 50%{box-shadow:0 4px 20px rgba(218,165,32,0.15)} }
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 768px) {
          ...
          .nav-logo { width: 100% !important; height: auto !important; aspect-ratio: 2.487; }
          ...
          .nav-mobilebtns button, .nav-mobilebtns a { width: 100% !important; height: 44px !important; font-size: 12.5px !important; font-weight: 700 !important; padding: 0 2px !important; white-space: nowrap !important; display: flex !important; align-items: center !important; justify-content: center !important; border-radius: 10px !important; }
          ...
          .hero-panel { width: 100% !important; padding: 14px !important; margin-top: 0 !important; } .hero-mobilebtns { display: flex !important; justify-content: center !important; max-width: 420px !important; margin-left: auto !important; margin-right: auto !important; } .hero-panel { display: none !important; } .hero-panel.mob-open { display: block !important; } .hero-mobile-ai { display: flex !important; } .hero-mobilebtns button { white-space: nowrap !important; font-size: 15px !important; height: 52px !important; padding: 0 22px !important; gap: 7px !important; border-radius: 12px !important; flex: 1 1 0 !important; min-width: 0 !important; max-width: 200px !important; box-sizing: border-box !important; background: #2563EB !important; color: #fff !important; border-color: #2563EB !important; } .browse-box { display: none !important; }
      ...
      <nav style={{position:'sticky',top:0,zIndex:100,background:'#F9FAFB',borderBottom:'1px solid #EBEBEB'}}>
        <div className="nav-inner" style={{maxWidth:'1280px',margin:'0 auto',padding:'0 20px',height:'88px',display:'flex',alignItems:'center',gap:'12px'}}>
          <a href={`/${locale}`} style={{textDecoration:'none',flexShrink:0}}>
            <span className="nav-logo" style={{display:'block',width:'189px',height:'76px',overflow:'hidden',position:'relative'}}><img src="/logo-flat.jpeg" alt="ETHIOFY - Ethiopia's No. 1 Marketplace" style={{position:'absolute',width:'139.2%',maxWidth:'none',left:'-20.1%',top:'-59.2%'}} /></span>
          </a>
          <div className="nav-mobilebtns" style={{display:'none'}}><AuthButton/><a href={`/${locale}/post`} style={{flex:1,height:'44px',display:'flex',alignItems:'center',justifyContent:'center',background:'#111',color:'#fff',borderRadius:'10px',fontSize:'14px',fontWeight:700,textDecoration:'none'}}>+ Post Ad</a><button onClick={()=>{setAiOpen(o=>!o); if(mobileFilters)setMobileFilters(false)}} style={{flex:1,height:'44px',borderRadius:'10px',border:'1.5px solid #111',background:'#fff',color:'#111',fontSize:'14px',fontWeight:700,cursor:'pointer',fontFamily:'inherit'}}>✦ AI Assistant</button><button onClick={()=>{setMobileFilters(o=>!o); if(aiOpen)setAiOpen(false)}} style={{flex:1,height:'44px',borderRadius:'10px',border:'none',background:'#111',color:'#fff',fontSize:'14px',fontWeight:700,cursor:'pointer',fontFamily:'inherit'}}>⌕ Search</button></div>
