...
@keyframes featuredshimmer { 0%,100%{box-shadow:0 0 0 rgba(218,165,32,0)} 50%{box-shadow:0 4px 20px rgba(218,165,32,0.15)} }
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 768px) {
          ...
          .nav-taglines { display: block !important; width: 100%; margin: 0 0 8px; }
          ...
          .hero-inner > div:not(.hero-video) { display: contents !important; }
          .hero-tabs { order: -2 !important; width: 100% !important; margin: 0 0 10px !important; padding: 0 !important; }
          .hero-tab { font-size: 16px !important; font-weight: 800 !important; padding: 11px 16px !important; }
