...
@keyframes featuredshimmer { 0%,100%{box-shadow:0 0 0 rgba(218,165,32,0)} 50%{box-shadow:0 4px 20px rgba(218,165,32,0.15)} }
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 768px) {
          .nav-inner { padding: 0 12px !important; gap: 8px !important; height: 84px !important; }
          .nav-logo { transform: scale(0.8); transform-origin: left center; margin-right: -38px; }
      ...
      <nav style={{position:'sticky',top:0,zIndex:100,background:'#F9FAFB',borderBottom:'1px solid #EBEBEB'}}>
        <div className="nav-inner" style={{maxWidth:'1280px',margin:'0 auto',padding:'0 20px',height:'88px',display:'flex',alignItems:'center',gap:'12px'}}>
          <a href={`/${locale}`} style={{textDecoration:'none',flexShrink:0}}>
            <span className="nav-logo" style={{display:'block',width:'189px',height:'76px',overflow:'hidden',position:'relative'}}><img src="/Ethiofy final logo.jpeg" alt="ETHIOFY - Ethiopia's No. 1 Marketplace" style={{position:'absolute',width:'263px',maxWidth:'none',left:'-38px',top:'-45px'}} /></span>
          </a>
