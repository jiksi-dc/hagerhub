...
@keyframes featuredshimmer { 0%,100%{box-shadow:0 0 0 rgba(218,165,32,0)} 50%{box-shadow:0 4px 20px rgba(218,165,32,0.15)} }
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 768px) {
          ...
          .cats-wrap::after { content: ''; position: absolute; top: 0; right: 0; width: 44px; height: 100%; background: linear-gradient(to right, rgba(249,250,251,0), #F9FAFB 70%); pointer-events: none; }
          .cats-wrap::before { content: '›'; position: absolute; right: 10px; top: 50%; transform: translateY(-50%); z-index: 2; font-size: 22px; font-weight: 900; color: #111; pointer-events: none; }
          .nav-cats { display: flex; width: 100%; overflow-x: auto; gap: 3px; padding: 0 44px 8px 10px; scrollbar-width: none; }
          .nav-cats::-webkit-scrollbar { height: 3px; }
          .nav-cats::-webkit-scrollbar-thumb { background: #D1D5DB; border-radius: 3px; }
          .nav-cats button { font-size: 16px !important; font-weight: 700 !important; padding: 9px 14px !important; }
